  ...
  return (
    <View className="flex flex-col items-center justify-center gap-2">
      <View
        ...
        {covers.map((playlist, idx) => (
          <Image
            key={playlist.libraryItemId}
            source={{
              uri: `${store$.settings.serverUrl.peek()}/api/items/${playlist.libraryItemId}/cover?format=webp`,
            ...
            contentFit="cover"
            recyclingKey={playlist.libraryItemId}
